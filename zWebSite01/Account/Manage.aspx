...
<asp:Content ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section id="externalLoginsForm">
        ...
        <asp:ListView runat="server"
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        crap -a-s-p:Button runat="server" Text="Remove" CommandName="Delete" CausesValidation="false" 
                            ToolTip='< % #: "Remove this " & Item . ProviderDisplayName & " login from your account" % >'
                            Visible="< % # Can Remove External Logins % >" />
                    </td>
        ...
        <crap uc:OpenAuthProviders runat="server" ReturnUrl="~/Account/Manage" />
    </section>
	-->
</asp:Content>
